...
Item {
    ...
    Column {
        ...
        FormSection {
            title: "錄音行為"
        Text { text: "預覽間隔（毫秒）"; color: Theme.inkBody; font.family: journal.systemFontFamily; font.pixelSize: root.px(16) }
        ...
        Text { text: "靜音分段（毫秒）"; color: Theme.inkBody; font.family: journal.systemFontFamily; font.pixelSize: root.px(16) }
        ...
        Text { text: "片段最長（毫秒）"; color: Theme.inkBody; font.family: journal.systemFontFamily; font.pixelSize: root.px(16) }
        ...
        Text {
            ...
            wrapMode: Text.Wrap
            color: journal.inputFallbackActive ? Theme.warning : Theme.inkMuted
            font.family: journal.systemFontFamily
        ...
        Rectangle {
            ...
            color: Theme.wash(Theme.warningStrong, 0.20)
        ...
        Rectangle {
            ...
            color: Theme.paperSunken
            Rectangle {
                width: parent.width * journal.microphoneTestLevel
                height: parent.height
                radius: parent.radius
                color: journal.microphoneTestState === "error" ? Theme.dangerStrong :
                       journal.microphoneTestState === "warning" ? Theme.warningStrong : Theme.accent
            }
        }
        Text {
            ...
            wrapMode: Text.Wrap
            color: journal.microphoneTestState === "error" ? Theme.danger :
                   journal.microphoneTestState === "warning" ? Theme.warning : Theme.accentDeep
            font.family: journal.systemFontFamily
            font.pixelSize: root.px(14)
        }
        PaperButton {
        ...
        RowLayout {
            ...
            TextField {
                ...
                font.family: journal.systemFontFamily
                font.pixelSize: root.px(16)
                background: Rectangle { radius: Theme.radiusSm; color: Theme.paperRaised; border.color: Theme.line }
            }
            PaperButton {
                text: "瀏覽…"
    ...
    // Saving is the drawer's one commit action; it stays reachable no matter how
    // far the form has been scrolled.
    Item {
        id: saveFooter
        anchors.left: parent.left
        anchors.right: parent.right
        anchors.bottom: parent.bottom
        height: saveButton.implicitHeight + Theme.spaceMd
